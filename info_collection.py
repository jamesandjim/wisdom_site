...
class Ui_info_collect_Form(object):
    def setupUi(self, info_collect_Form):
        ...
        info_collect_Form.resize(1146, 731)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 30, 651, 641))
        ...
        self.lb_photo3.setGeometry(QtCore.QRect(840, 360, 171, 221))
        self.lb_photo3.setObjectName("lb_photo3")
        self.widget = QtWidgets.QWidget(self.tab)
        self.widget.setGeometry(QtCore.QRect(830, 80, 231, 231))
        self.widget.setObjectName("widget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.pb_cj = QtWidgets.QPushButton(self.widget)
        self.pb_cj.setFlat(False)
        self.pb_cj.setObjectName("pb_cj")
        self.verticalLayout.addWidget(self.pb_cj)
        self.pb_uploadPhoto = QtWidgets.QPushButton(self.widget)
        ...
        self.pb_save_upload = QtWidgets.QPushButton(self.widget)
        self.pb_save_upload.setObjectName("pb_save_upload")
        self.verticalLayout.addWidget(self.pb_save_upload)
        self.pb_cj_photo = QtWidgets.QPushButton(self.widget)
