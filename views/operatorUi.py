...
"}")
        ...
        self.le_qxz = QtWidgets.QLineEdit(self.widget)
        self.le_qxz.setObjectName("le_qxz")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.le_qxz)
        self.label_5 = QtWidgets.QLabel(self.widget)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_5)
        self.checkBox_isAdmin = QtWidgets.QCheckBox(self.widget)
        self.checkBox_isAdmin.setObjectName("checkBox_isAdmin")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.checkBox_isAdmin)
        ...
        self.tv_operator = QtWidgets.QTableView(self.widget)
        self.tv_operator.setAlternatingRowColors(True)
        self.tv_operator.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tv_operator.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tv_operator.setWordWrap(False)
        self.tv_operator.setObjectName("tv_operator")
        self.tv_operator.horizontalHeader().setDefaultSectionSize(200)
        self.verticalLayout_3.addWidget(self.tv_operator)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "操作员名称"))
        self.label_2.setText(_translate("Form", "操作员密码"))
        self.label_3.setText(_translate("Form", "权限组"))
        self.label_5.setText(_translate("Form", "管理员"))
        self.checkBox_isAdmin.setText(_translate("Form", "是否管理员"))
